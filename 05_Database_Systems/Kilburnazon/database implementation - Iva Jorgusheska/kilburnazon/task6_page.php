...
include("audit_delete.php");
include("updating_employee.php");

if (isset($_POST['audit_emp'])){
	if(isValid() && isValid6()){
		audit_employee();
		$message = "Employee deleted successfully";
		echo '<div style="position: absolute; top: 350px; left: 500px; color: green;">' . $message . '</div>';
	}
	else{
